...
//     return sum;
// }
// const test=sumdigits('helloworld123');
// console.log(test);
// function add(str){
//     var strarr=str.split("");
//     let totNum=0,totLetters=0;
//     for(i=0;i<strarr.length;i++){
//         if(!isNaN(strarr[i])){
//             totNum+=parseInt(strarr[i]);
//         }     
//     } 
//     totLetters=str.replace(/[^a-z]/gi, "").length;
//     console.log(Math.round(totNum/totLetters));
// }
// var str = 'foo5b,ar6cat1';

// add("helloworld124")

// function add(str)
// {
//     let strtmp=0,strcmp=0;
//     let strarr=str.split("");
//     for(let i=0;i<strarr.length;i++){
//         if(!isNaN(strarr[i])){
//             strtmp+=parseInt(strarr[i]);
//         }
//     }
//     strcmp=str.replace(/[^a-z]/gi,"").length;
//     console.log(Math.round(strtmp/strcmp));
// }
// add("heello,world123");



// const doublen=number=>2*number;
// console.log(doublen(4));
// const nums=[1,2,3];
// const res=nums.map(n=>2*n);
...
//     teamsummury:function(){
//         return this.members.map((member)=>{
//             return `${member} is on team ${this.teamname}`;
//         });
//     }
// };
// console.log(team.teamsummury());
...
//     }
// }
// console.log(addictivepersistance(1234));
//==============Q1==============
// function arraychallenge(strarr){
    
//         let arr2=strarr.sort(function(a,b){
...
// };
// const ans = arraychallenge(["hello", "world", "after", "all"]);
// console.log(ans);
...
// const v1=object.data.split(",");
// var array2 = [];
// for (var i = 0; i < v1.length; i++) {
//     var split = v1[i].split("="); 
//     array2.push(split[1]);
// }
// let total;
...
//         if(arr[i]-arr[i-1]!==diff) arithmetic=false;
//     }
...
//     });
//     }
// const change=LetterChanges("hello*3");
// console.log(change);
...
//     }
// }
// const simpleadd=simpleadding(4);
...
// //numbersoup
// function alphabeticalsoup(str){
//     let letters= str.split('');
//     return letters.sort().join('');
// }
// console.log(alphabeticalsoup('coderbyte'));
...
//     }
// }
// console.log(checknums(5,4));
// //
// function timeconv(num)
// {
//     var hours=Math.floor(num/60);
//     var miniutes=num%60;
//     var str=hours+":"+miniutes;
//     return str;
// }
// //abcheck
// function abcheck(str){
...
function EXoh(str){
    ...
    var ocount=letters.filter(function(ch){
        return  ch==='x';
    }).length;
    var xcount=letters.filter(function(ch){
        return ch==='o';
    })
...
const ag=arithgeo([2,4,16,24]);
//console.log(ag);
function arrayaddition(arr){
    var target;
    var addarr=arrayPrep(arr);
    var len=addarr.length;
    var pernum=Math.pow(2,len);
    console.log('test0',pernum,target,addarr);
